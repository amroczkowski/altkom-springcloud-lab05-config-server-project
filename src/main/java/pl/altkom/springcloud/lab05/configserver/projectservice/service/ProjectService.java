package pl.altkom.springcloud.lab05.configserver.projectservice.service;
...
import pl.altkom.springcloud.lab05.configserver.projectservice.client.EmployeeClient;
import pl.altkom.springcloud.lab05.configserver.projectservice.controller.mapper.RequestMapper;
import pl.altkom.springcloud.lab05.configserver.projectservice.controller.mapper.ResponseMapper;
import pl.altkom.springcloud.lab05.configserver.projectservice.controller.model.CreateProjectRequest;
import pl.altkom.springcloud.lab05.configserver.projectservice.controller.model.Employee;
...
import pl.altkom.springcloud.lab05.configserver.projectservice.repository.ProjectRepository;
...
public class ProjectService {
    ...
    public Project getProject(final Long projectId) {
        final pl.altkom.springcloud.lab05.configserver.projectservice.repository.model.Project project = projectRepository.findById(projectId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
        final List<Employee> employees = pl.altkom.springcloud.lab05.configserver.projectservice.client.mapper.ResponseMapper.map(employeeClient.getProjectEmployees(project.getId()));
    ...
    public Project updateProject(final Long projectId, final UpdateProjectRequest request) {
        ...
        final pl.altkom.springcloud.lab05.configserver.projectservice.repository.model.Project modifiedProject = projectRepository
                .save(RequestMapper.bind(request, sourceProject));
        final List<Employee> employees = pl.altkom.springcloud.lab05.configserver.projectservice.client.mapper.ResponseMapper
